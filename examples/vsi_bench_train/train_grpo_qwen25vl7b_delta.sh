...
EXPERIMENT_NAME="vsi_train_grpo_qwen25vl7b"

BASEDIR=$(pwd)
SCRIPTDIR=$(dirname "$0")
EXPERIMENT_DIR=/work/hdd/bgig/kwang22/projects/viewsuite/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}
SAVE_CHECKPOINT_DIR=${EXPERIMENT_DIR}/verl_checkpoints
DATASET_TRAIN=${SCRIPTDIR}/train_delta.yaml
DATASET_VAL=${SCRIPTDIR}/val_delta.yaml
agent_loop_config_path=${BASEDIR}/vagen/configs/agent.yaml
REF_MODEL_PATH=/work/hdd/bgig/kwang22/Qwen2.5-VL-7B-Instruct
