...
EXPERIMENT_NAME="action_gen_grpo_qwen25vl7b_0_5"

BASEDIR=$(pwd)
SCRIPTDIR=$(dirname "$0")
EXPERIMENT_DIR=${BASEDIR}/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}
SAVE_CHECKPOINT_DIR=${EXPERIMENT_DIR}/verl_checkpoints
DATASET_TRAIN=${SCRIPTDIR}/train_proxy_0_5.yaml
DATASET_VAL=${SCRIPTDIR}/val_proxy_0_5.yaml
agent_loop_config_path=${BASEDIR}/vagen/configs/agent.yaml
REF_MODEL_PATH=~/projects/viewsuite/VAGEN/exps/verl_vagen/action_gen_grpo_qwen25vl7b_0_2/verl_checkpoints/global_step_20/actor/huggingface
