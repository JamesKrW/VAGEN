...
EXPERIMENT_NAME="fwd_inv_grpo_qwen25vl7b_iter960"

BASEDIR=$(pwd)
SCRIPTDIR=$(dirname "$0")
EXPERIMENT_DIR=${BASEDIR}/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}
SAVE_CHECKPOINT_DIR=${EXPERIMENT_DIR}/verl_checkpoints
DATASET_TRAIN=${SCRIPTDIR}/train_proxy_inv.yaml
DATASET_VAL=${SCRIPTDIR}/val_proxy_inv.yaml
agent_loop_config_path=${BASEDIR}/vagen/configs/agent.yaml
REF_MODEL_PATH=~/projects/viewsuite/data/checkpoints/iter5_rl_960
