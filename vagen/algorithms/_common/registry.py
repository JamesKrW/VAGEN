"""Shared algorithm registry metadata declared where an estimator registers.
...
def wants_turn_lumped_reward(adv_estimator) -> bool:
    ...
    ``vagen.algorithms.bi_level_gae.bi_level_gae._lump_rewards_at_turn_end``.
    Environments do not know which estimator will read them, and nothing asks them to.
    """
