...
from vagen.algorithms._common.trajectory import TrajectoryView, to_int64_codes
...
def _compute_token_level_gae(inputs: AdvantageInputs):
...
def _compute_default_gae(inputs: AdvantageInputs):
...
def _compute_trajectory_grpo(inputs: AdvantageInputs):
...
def _compute_bi_level_gae(inputs: AdvantageInputs):
...
def _compute_turn_level_gae(inputs: AdvantageInputs):
